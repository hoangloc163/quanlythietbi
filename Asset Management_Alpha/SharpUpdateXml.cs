...
namespace Asset_Management_Alpha
{
    internal class SharpUpdateXml
    {
        ...
        internal SharpUpdateXml(Version version, Uri uri, string fileName, string md5, string description, string lauchAgrs)
        {
        ...
        internal static SharpUpdateXml Parse(Uri location, string appID)
        {
            ...
            try
            {
                ...
                return new SharpUpdateXml(version, new Uri(url), fileName, md5, description, lauchArgs);
            }
            catch
            {
                return null;
